      ...
      switchMap((_) => {
        return this.clientsService.getClients().pipe(
          ...
          catchError((errorResponse: HttpErrorResponse) => {
            return of(
              getAllClientsFailureAction({ errors: errorResponse.error.errors })
            );
          })
        );
      })
    ...
    this.actions$.pipe(
      ...
      switchMap(({ client }) => {
        return this.clientsService.createClient(client).pipe(
          ...
          catchError((errorResponse: HttpErrorResponse) => {
            return of(
              createClientFailureAction({ errors: errorResponse.error.errors })
            );
          })
        );
      })
    ...
    this.actions$.pipe(
      ...
      switchMap(({ _id }) => {
        return this.clientsService.deleteClient(_id).pipe(
          ...
          catchError((errorResponse: HttpErrorResponse) => {
            return of(
              deleteClientFailureAction({ errors: errorResponse.error.errors })
            );
          })
        );
      })
    ...
    this.actions$.pipe(
      ...
      switchMap(({ client }) => {
        return this.clientsService.updateClient(client).pipe(
          ...
          catchError((errorResponse: HttpErrorResponse) => {
            return of(
              updateClientFailureAction({ errors: errorResponse.error.errors })
            );
          })
        );
      })
